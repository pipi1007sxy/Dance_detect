...
if __name__ == '__main__':
    ...
    parser.add_argument('--labels', type=str,  help='path to json with keypoints val labels',default="E:\BaiduNetdiskDownload\OpenPose_dance_system\code\scripts\pval_subset.json")
    parser.add_argument('--output-name', type=str, default='detections.json',
                        help='name of output json file with detected keypoints')
    parser.add_argument('--images-folder', type=str, help='path to COCO val images folder',default="E:\BaiduNetdiskDownload\OpenPose_dance_system\code\datasets\coco\images\pval2017")
    parser.add_argument('--checkpoint-path', type=str,help='path to the checkpoint',default="E:\BaiduNetdiskDownload\OpenPose_dance_system\code\default_checkpoints\checkpoint_iter_5000.pth")
