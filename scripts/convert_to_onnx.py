...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint-path', type=str,  help='path to the checkpoint',default="E:\BaiduNetdiskDownload\OpenPose_dance_system\code\default_checkpoints")
