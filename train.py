...
if __name__ == '__main__':
    ...
    parser.add_argument('--prepared-train-labels', type=str,
                        help='path to the file with prepared annotations', default="E:\BaiduNetdiskDownload\OpenPose_dance_system\code\scripts\prepared_train_annotation.pkl")
    parser.add_argument('--train-images-folder', type=str, help='path to COCO train images folder',default="E:\BaiduNetdiskDownload\OpenPose_dance_system\code\datasets\coco\images\ptrain2017")
    ...
    parser.add_argument('--val-labels', type=str, help='path to json with keypoints val labels',default="E:\BaiduNetdiskDownload\OpenPose_dance_system\code\scripts\pval_subset.json")
    parser.add_argument('--val-images-folder', type=str,  help='path to COCO val images folder',default="E:\BaiduNetdiskDownload\OpenPose_dance_system\code\datasets\coco\images\pval2017")
